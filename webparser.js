...
const table = document.querySelector(".humany-html>table");
...
if (table) {
  ...
  targetDiv.innerHTML = `
          ...
          <div class="right-info-container erik-new">
  ...
  const innerTableRows = document.querySelectorAll(".right-top-container tr");
